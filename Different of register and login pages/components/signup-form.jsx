    ...
    <div className={"flex flex-col gap-6"}>
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={signup.handleSubmit(handleSignup)}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold">Welcome To Name of the project</h1>
                <p className="text-balance text-muted-foreground">Signup to your Acme Inc account</p>
              </div>
                <FormField
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="flex items-center border rounded px-2">
                          ...
                          <Input className="border-0 focus:ring-0" placeholder="Enter Your Name" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
